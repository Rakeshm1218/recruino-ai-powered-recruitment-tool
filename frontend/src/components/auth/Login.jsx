    ...
    <div className="min-h-screen flex flex-col bg-blue-600 lg:bg-gray-100 lg:flex-row">
      ...
      <div className="lg:hidden flex justify-center items-center pt-8 pb-4">
        <div className="flex items-center">
          ...
          <span className="text-xl font-bold text-white">Recruino</span>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
          <div className="mb-8">
            <h2 className="text-xl md:text-3xl font-bold text-gray-800 mb-2">Welcome back</h2>
            <p className="text-gray-600 text-sm md:text-md">Please enter your credentials to access your account</p>
          </div>
